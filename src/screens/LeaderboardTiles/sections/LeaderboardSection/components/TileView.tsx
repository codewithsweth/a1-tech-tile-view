              ...
              >
                ...
                >
                  <CardContent sx={{ 
                    ...
                    {/* Badges positioned at bottom of image */}
                    <Box
                      sx={{
                        position: 'absolute',
                        bottom: '8px',
                    ...
                    >
                      ...
                      {/* Badge counter for additional badges */}
                      {(() => {
                        const totalBadges = (person.hasHighestBadge ? 1 : 0) + (person.hasHotStreakBadge ? 1 : 0);
                        const additionalBadges = Math.max(0, totalBadges - 2);
                        
                        // For demo purposes, let's assume some people have more badges
                        const demoAdditionalBadges = person.rank === 2 ? 2 : person.rank === 3 ? 1 : 0;
